...
import { DofusItem, PriceHistoryEntry } from "@/types/dofus";
...
const Prices = () => {
  const datasetVersion: "20" | "129" = "129";
  const server = "Abrak";
  ...
  const { resourcePrices, itemPrices, resourcePriceHistory, itemPriceHistory } = usePrices(server, datasetVersion);
